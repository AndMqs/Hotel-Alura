...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desenvolvido por Andresa © 2023");
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int opcao = JOptionPane.showOptionDialog(null, "Deseja realmente sair?", "Encerrando", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]);
				if(opcao == 0){
					System.exit(0);					
				}
